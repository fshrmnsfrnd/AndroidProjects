...
public class RindenRechner{
    public static HashMap<String, double[]> BaumKoffizienten= new HashMap<>(){
        {
    ...
    public static double[] getKoffizient(String baumArt){
        ...
        if(RindenRechner.BaumKoffizienten.containsKey(baumArt)){
            return RindenRechner.BaumKoffizienten.get(baumArt);
        }else{
    ...
    public static boolean validateBaumart(String baumArt){
        return RindenRechner.BaumKoffizienten.containsKey(baumArt);
    }
}
